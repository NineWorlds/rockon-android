...
public class RockOnSettings extends PreferenceActivity {
    ...
    private final String KEY_TOGGLE_SHOW_ICON = Filex.PREFS_SHOW_ICON;
    private final String KEY_TOGGLE_SCROBBLE_DROID = Filex.PREFS_SCROBBLE_DROID;
    private final String KEY_TOGGLE_SHOW_ART_WHILE_SCROLLING = Filex.PREFS_SHOW_ART_WHILE_SCROLLING;
    private final String KEY_TOGGLE_SHOW_FRAME = Filex.PREFS_SHOW_FRAME;
    private final String KEY_TOGGLE_ALWAYS_LANDSCAPE = Filex.PREFS_ALWAYS_LANDSCAPE;
    private final String KEY_TOGGLE_AUTO_ROTATE = Filex.PREFS_AUTO_ROTATE;
    private final String KEY_TOGGLE_CUSTOM_BACKGROUND = Filex.PREFS_CUSTOM_BACKGROUND;
    private final String KEY_TOGGLE_CUSTOM_BACKGROUND_PORTRAIT =
    	Filex.PREFS_CUSTOM_BACKGROUND_PORTRAIT;
    private final String KEY_TOGGLE_CUSTOM_BACKGROUND_LANDSCAPE =
    	Filex.PREFS_CUSTOM_BACKGROUND_LANDSCAPE;
    
    private	final String FILEX_PREFERENCES_PATH = "/sdcard/RockOn/preferences/";
    private final String FILEX_BACKGROUND_PATH = Filex.FILEX_BACKGROUND_PATH;
